...
const Todo = () => {
  ...
  const gettask = () => {
    ...
    Axios.get("https://mern-crud-todo-server.herokuapp.com/")
      .then((response) => {
...
const updateTask = (id)=>{
  ...
  Axios.get(`https://mern-crud-todo-server.herokuapp.com/${id}`)
  .then(async(response)=> 
    {
...
const getting = ()=>{
  ...
  Axios.get('https://mern-crud-todo-server.herokuapp.com/getting')
  .then((response)=>{
...
let AddTask=()=>{
  Axios.post("https://mern-crud-todo-server.herokuapp.com/createtask", {
    task: task,
    deadline: deadline,
  }).then((response) => {
    console.log(response.data);
...
const updatingTask =()=>{
  ...
  Axios.put("https://mern-crud-todo-server.herokuapp.com/update",{taskname:task,deadline:deadline, id:objup})
  .then(()=>
  {
    setFlag(0)
    console.log('flag',flag)
